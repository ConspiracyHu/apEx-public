...
namespace WaveSabreCore
{
	StateVariableFilter::StateVariableFilter()
	{
		...
		type = StateVariableFilterType::StateVariableFilterType_Lowpass;
		freq = 20.0f;
		q = 1.0f;
	...
	float StateVariableFilter::run(float input)
	{
		...
		switch (type)
		{
		case StateVariableFilterType::StateVariableFilterType_Lowpass:
		default:
			return low;

		case StateVariableFilterType::StateVariableFilterType_Highpass: return high;
		case StateVariableFilterType::StateVariableFilterType_Bandpass: return band;
		case StateVariableFilterType::StateVariableFilterType_Notch: return low + high;
		}
	}
}
